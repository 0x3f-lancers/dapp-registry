...
//     constructor(
//       public body: any,
//       public init: { status: number; statusText: string; url: string },
//     ) {
//       this.url = init.url; // Assign url from init
//     }
//     get ok() {
...
//     // Default fetch mock to success, ensuring response.url matches the requested URL
//     mockFetch.mockImplementation((url: string) =>
//       Promise.resolve(new Response(null, { status: 200, statusText: "OK", url } as any)),
//     );
//   });
...
describe("Link Checker Script (scripts/check-links.ts)", () => {
  ...
  beforeEach(() => {
    ...
    // Default fetch mock - return a plain object
    mockFetch.mockImplementation((url: string) =>
      Promise.resolve({
        ok: true,
        status: 200,
